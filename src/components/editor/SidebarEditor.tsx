...
export type SidebarEditorProps = Pick<
  UseStoryStateResult,
  | "nodes"
  | "variables"
  | "characters"
...
interface MiniGameSummaryItem {
  label: string;
  value: string;
}

interface MiniGameSummaryInput {
  blockType: string;
  options: unknown[];
...
export default function SidebarEditor({
  ...
  const isMiniGameBlock = (
    ["traitPicker", "persuasion", "choiceWeighting"] as string[]
  ).includes(blockType);
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e: ChangeEvent<HTMLInputElement>) =>
            updateSelectedNodeField("title", e.target.value)
          }
      ...
      <div className="form-group">
        ...
        <select
          ...
          onChange={(e: ChangeEvent<HTMLSelectElement>) =>
            updateSelectedNodeField("blockType", e.target.value)
          }
        >
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={(e: ChangeEvent<HTMLTextAreaElement>) =>
                updateSelectedNodeField("content", e.target.value)
              }
...
function getMiniGameDisplayName(blockType: string): string {
  switch (blockType) {
    case "traitPicker":
      return "Trait Picker";
    case "persuasion":
...
function getMiniGamePromptPlaceholder(blockType: string): string {
  switch (blockType) {
    case "traitPicker":
...
function getMiniGameSummary({
  ...
  continueNodeId,
  choices,
}: MiniGameSummaryInput): MiniGameSummaryItem[] {
  switch (blockType) {
    case "traitPicker":
      return [
...
function VariablesWorkspacePromo({
  variables,
  onOpenVariables,
}: {
...
const miniGameStyles: Record<string, CSSProperties> = {
  card: {
